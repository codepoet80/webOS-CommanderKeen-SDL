...
#ifdef __webos__
			// GLES: Use vertex arrays with triangle strip
			GLfloat vertices[] = {
				(GLfloat)clip_sx_beg, (GLfloat)clip_sy_beg,
				(GLfloat)clip_sx_beg, (GLfloat)clip_sy_end,
				(GLfloat)clip_sx_end, (GLfloat)clip_sy_beg,
				(GLfloat)clip_sx_end, (GLfloat)clip_sy_end
			};
			GLfloat texcoords[] = {
