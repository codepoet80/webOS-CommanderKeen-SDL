...
void DrawHLine(Uint32 color, int x, int y, int width)
{
	...
	glColor4ub(r, g, b, a);
#ifdef __webos__
	GLfloat vertices[] = { (GLfloat)x, (GLfloat)y, (GLfloat)(x + width), (GLfloat)y };
	glEnableClientState(GL_VERTEX_ARRAY);
...
void DrawVLine(Uint32 color, int x, int y, int height)
{
	...
	glColor4ub(r, g, b, a);
#ifdef __webos__
	GLfloat vertices[] = { (GLfloat)x, (GLfloat)y, (GLfloat)x, (GLfloat)(y + height) };
	glEnableClientState(GL_VERTEX_ARRAY);
	glVertexPointer(2, GL_FLOAT, 0, vertices);
	glDrawArrays(GL_LINES, 0, 2);
	glDisableClientState(GL_VERTEX_ARRAY);
...
void DrawLine(Uint32 color, int x1, int y1, int x2, int y2)
{
	...
	glColor4ub(r, g, b, a);
#ifdef __webos__
	GLfloat vertices[] = { xx1, yy1, xx2, yy2 };
	glEnableClientState(GL_VERTEX_ARRAY);
	glVertexPointer(2, GL_FLOAT, 0, vertices);
	glDrawArrays(GL_LINES, 0, 2);
	glDisableClientState(GL_VERTEX_ARRAY);
...
void DrawRectangle(Uint32 color, int x, int y, int w, int h)
{
	...
	GLfloat vertices[] = {
		...
		(GLfloat)(x + w - 1), (GLfloat)(y + 1),
		(GLfloat)(x + w - 1), (GLfloat)(y + h),
		(GLfloat)(x + w - 1), (GLfloat)(y + h - 1),
		(GLfloat)x, (GLfloat)(y + h - 1),
		(GLfloat)x, (GLfloat)(y + h - 1),
